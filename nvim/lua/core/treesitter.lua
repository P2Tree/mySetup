...
treesitter.setup {
  ...
  ensure_installed = { "vim", "lua", "luadoc", "json", "yaml", "c", "cpp", "llvm", "tablegen", "python", "ninja", "make", "cmake", "markdown", "cuda", "diff", "git_config", "git_rebase", "gitattributes", "gitcommit", "gitignore", "ini" },
