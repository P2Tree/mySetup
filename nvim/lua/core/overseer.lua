...
vim.keymap.set("n", "<leader>rr", "<cmd>OverseerRun<CR>", { desc = "Task Run" })
vim.keymap.set("n", "<leader>rl", "<cmd>OverseerToggle<CR>", { desc = "Task List" })
vim.keymap.set("n", "<leader>rn", "<cmd>OverseerBuild<CR>", { desc = "Task Build" })
...
vim.keymap.set("n", "<leader>rc", "<cmd>OverseerClearCache<CR>", { desc = "Clear Task Cache" })
